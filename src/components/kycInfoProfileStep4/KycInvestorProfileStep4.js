...
function KycInvestorProfileStep4({
  formData,
  handleInputChange,
  setSelectedStep,
}) {
  ...
  const investordp = localStorage.getItem("investorDp");
      ...
      <div className="kyc__info__profile__step4__main___container">
        ...
        <div className="kyc__info__profile__step4__main___container1">
          {investerkycapproval === "accepted" &&
            <div className="ProfileForm" style={{ border: "none" }}>
            ...
            style={{
              opacity:
                investerkycapproval === "pending" ||
                  ...
                  ? "0.6"
                  : "1",
                  display: investerkycapproval === "pending"  ? "none":"sdffsdg"
            }}
          >
            {investerkycapproval === "pending"
              ? "Request Pending"
...
export default KycInvestorProfileStep4;
