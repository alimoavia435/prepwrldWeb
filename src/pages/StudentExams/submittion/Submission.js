  ...
  console.log("resultdata", resultdata);
    ...
    if (isNextGen && currentSubQuestionIndex > 0) {
        setCurrentSubQuestionIndex(prev => {
            ...
            storageHelpers.saveState(LOCAL_STORAGE_KEYS.CURRENT_SUB_QUESTION, newIndex);
            return newIndex;
        });
        setSubmitted(false);
        ...
        if (prevQuestion.type === "nextgen") {
            ...
            storageHelpers.saveState(LOCAL_STORAGE_KEYS.CURRENT_SUB_QUESTION, lastSubIndex);
        } else {
    ...
    const handleNext = () => {
        if (currentQuestionIndex < questions.length - 1) {
            ...
            storageHelpers.saveState(LOCAL_STORAGE_KEYS.CURRENT_QUESTION, currentQuestionIndex + 1);
            storageHelpers.saveState(LOCAL_STORAGE_KEYS.CURRENT_SUB_QUESTION, 0);
        } else {
        ...
        >
          {isNextGen
            ...
            : `Question ${currentQuestionIndex + 1} of ${questions.length}`}
              ...
              console.log("Current Sub Question Index:", currentSubQuestionIndex);
                      ...
                      <h4>{subQuestion?.question}</h4>
                                                            ...
                                                            <button
                                                                ...
                                                                style={{
                                                                    backgroundColor: submitted
                                                                        ? subQuestion.correctAnswers?.includes(option)
                                                                            ? "#90EE90"
                                                                            : selectedSubAnswers[currentSubQuestionIndex] === option
                                                                                ? "#FFCCCB"
                                                                                : "white"
                                                                        : selectedSubAnswers[currentSubQuestionIndex] === option
                                                                    ? "#e6f7ff"
                                                    ...
                                                    <div className="explanation">
                                                        <p>
                                                            {subQuestion.correctAnswers?.includes(
                                                                ...
                                                                ? "✓ Correct!"
                                                                : `✗ Incorrect. The correct answer is: ${
                                                                    subQuestion.correctAnswers?.[0] || "Not available"
                                                                }`}
                                                        </p>
                                                    </div>
                                                )}
                                    ...
                                    return (
                                        <div className="sub-question">
                                            <h4>{subQuestion?.question}</h4>
                                            <p>
                                                Question format "{subQuestion?.format || subQuestion?.questionFormat}" 
