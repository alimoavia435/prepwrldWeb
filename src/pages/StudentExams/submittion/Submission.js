            ...
            <div>
              ...
              <div className="tab-content">
                ...
                {currentQuestion?.Questions[
                  ...
                  (info, index) =>
                    activeTab === `tab-${index}` && (
                      <div key={info._id} className="tab-panel">
                        <h3>{info.title}</h3>
                        <div
                    ...
                    return (
                      <div className="sub-question">
                        ...
                        <p className="instruction">
                          ...
                          issue, two priority actions, and two potential
                          outcomes:
                        </p>
                              ...
                              <ul>
                                {subQuestion.bowtieData?.outcomes.map(
                                  (outcome, index) => {
                                    ...
                                    const isSelected =
                                      selectedAnswers.outcomes?.includes(
                                        outcome
                                      );
                  ...
                  <p>
                    ...
                    {(() => {
                      const currentSubQuestion =
                        currentQuestion?.Questions[currentSubQuestionIndex];
                      console.log(
                        "Current Sub Question for Explanation:",
                        currentSubQuestion
                      );
                      return (
