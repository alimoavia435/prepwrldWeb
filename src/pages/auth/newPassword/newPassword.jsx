...
const NewPassword = () => {
  ...
  const handleResetPassword = async () => {
    ...
    const data = { email: email.toLowerCase(), newPassword: password, confirmPassword: password ,userType: userType?.toLowerCase() === "investor" ? "investor" : "Property Developer" };
  ...
  return (
    <>
      ...
      <div className="SignIn-div1">
          ...
          <img
            src={"https://nclextc.com/Images/Investor/resetinvBg.png"}
            alt=""
            className="qwere2"
          />
        </div>
